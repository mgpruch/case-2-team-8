...
ggplot(data = allcountriesw, mapping = aes(x = Apparatus, y = Score, fill = Nation)) +
  geom_violin() + theme_bw() + labs(title = "Distribution of Scores Across Appartus for US Women vs. Other Gymnasts") + theme(axis.title=element_text(size=.5),
        axis.text=element_text(size=6),
        axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        legend.key.height = unit(.3, 'cm'), #change legend key height
        legend.key.width = unit(.3, 'cm'), 
...
ggplot(data = allcountriesm, mapping = aes(x = Apparatus, y = Score, fill = Nation)) +
  geom_violin() + theme_bw() + labs(title = "Distribution of Scores Across Appartus for US Men vs. Other Gymnasts") + theme(axis.title=element_text(size=.5),
        axis.text=element_text(size=6),
        axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        legend.key.height = unit(.3, 'cm'), #change legend key height
        legend.key.width = unit(.3, 'cm'), 
