...
ggplot(data = us_men_gym_data, mapping = aes(x = Score)) + geom_histogram(fill = "light blue",binwidth = .5) + theme_bw() +
  labs(title = "Distribution of US Men's Gymnastics Scores", x = "Score", y = "Count")
ggplot(data = us_womens_gym_data, mapping = aes(x = Score)) + geom_histogram(fill = "light blue",binwidth = .4) + theme_bw() +
  labs(title = "Distribution of US Women's Gymnastics Scores", x = "Score", y = "Count")
